...
const t_2 = universal(import('__react_static_root__/src/pages/About'), universalOptions)
      t_2.template = '__react_static_root__/src/pages/About'
      
const t_3 = universal(import('__react_static_root__/src/pages/Contact'), universalOptions)
      t_3.template = '__react_static_root__/src/pages/Contact'
