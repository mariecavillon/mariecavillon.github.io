          ...
          <Grid.Item col="0111">
            <Card>
              ...
              <Dropdown className={styles.dropdown}>
                ...
                <Dropdown.Content>
                  <div>
                    <Paragraph>Ayant appris a évoluer dès mon plus jeune âge dans des <b>contextes pluri-culturels</b> avec souvent des systèmes de valeur différents, j’ai fait de cette appréhension de la différence une force.<br/>En développant ma tolérance, m’épanouissant professionnellement dans des environnements changeants, jonglant parmis des cultures d’entreprises différentes en tant que consultante, reliant des expertises distinctes entre elles via des postes transverses ou encore en construisant des équipes pluridisciplinaires en cultivant l’unicité de chacun.</Paragraph>
