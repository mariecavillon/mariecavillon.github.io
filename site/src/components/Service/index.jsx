              ...
              <Modal>
                ...
                <Modal.Content>
                  ...
                  <List className={styles.left}>
                    <List.Item><SubTitle small>Organisation des méthodes de travail</SubTitle>implémentation et suivi d'<b>OKR</b>, clarification des <b>rôles et responsabilités</b>, modes de <b>communications</b> et modalités de <b>décisions</b> dans des organisations souvent transverses et matricielles, gestion et <b>efficacité des process</b>...<br/>&nbsp;</List.Item>
                    <List.Item><SubTitle small>Accompagnement continue des talents et du middle management</SubTitle><b>Coaching en 1to 1</b> ou <b>facilitation au Co-développement</b>, avec une approche intégrative (GROW, Spirale dynamique, CNV, Analyse transactionnelle, PNL...)<br/>&nbsp;</List.Item>
                    <List.Item><SubTitle small>"Cultural awareness" & diversite</SubTitle>Internationalisation des équipes et/ou gestion d'équipes matricielles: <b>Introduction à la CNV</b> et <b>Ateliers de groupe sur l'"Intelligence culturelle"</b> (apprendre à être conscient de ses orientations cross-culturelles, normes et valeurs, découvrir comment les élargir, apprendre à idenfiier celle des autres et efficacement réduire les differences culturelles (communication, modes de travail...)</List.Item>
                  </List>
